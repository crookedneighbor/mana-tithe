...
describe("Warnings", () => {
  ...
  it("displays not found info", () => {
    ...
    expect(lis[0].textContent).toEqual(
      "card name A could not be found. Check your spelling.",
    );
    expect(lis[1].textContent).toEqual(
      "card name B could not be found. Check your spelling.",
    );
  });
